...
def propag(n,V):
    '''Prend en argument un format de matrice carrée, la provenance du vent à choisir parmi 'N', 'S', 'E', 'O', 'NE','NO', 'SO', 'SE', 'A', et renvoie la création d'une forêt, la mise en feu d'un arbre et la première étape de la propagation'''
